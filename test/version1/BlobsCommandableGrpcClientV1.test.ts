...
import { BlobsCommandableGrpcServiceV1 } from 'pip-services-blobs-node';
import { IBlobsClientV1 } from '../../src/version1/IBlobsClientV1';
import { BlobsCommandableGrpcClientV1 } from '../../src/version1/BlobsCommandableGrpcClientV1';
...
suite('BlobsCommandableGrpcClientV1', ()=> {
    let service: BlobsCommandableGrpcServiceV1;
    let client: BlobsCommandableGrpcClientV1;
    ...
    suiteSetup((done) => {
        ...
        let references: References = References.fromTuples(
            ...
            new Descriptor('pip-services-blobs', 'service', 'commandable-grpc', 'default', '1.0'), service
        );
        controller.setReferences(references);
        service.setReferences(references);

        client = new BlobsCommandableGrpcClientV1();
