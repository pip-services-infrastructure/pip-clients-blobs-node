# Development and Testing Guide <br/> Blobs Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-infrastructure/pip-clients-blobs-node.git
```
